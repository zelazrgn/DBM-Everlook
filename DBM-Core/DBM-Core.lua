...
if isClassic then
	...
	DBM.ReleaseRevision = releaseDate(2023, 4, 5) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
end
