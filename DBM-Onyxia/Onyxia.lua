...
mod:RegisterEventsInCombat(
	...
	"SPELL_CAST_SUCCESS 19633 18431",
...
local timerNextBellowingRoar	= mod:NewCDTimer(15, 18431, nil, nil, 3)
...
local timerNextFlameBreath	= mod:NewCDTimer(12, 18435, nil, "Tank|Healer", 3, 5)--13.3-20 Breath she does on ground in frontal cone.
...
do
	...
	function mod:SPELL_CAST_START(args)
		...
		elseif spellName == bellowingRoar and args:IsSrcTypeHostile() then        -- Bellowing Roar (Phase 3)
...
function mod:OnSync(msg, guid)
	...
	elseif msg == "Phase3" then
		...
		timerNextBellowingRoar:Start(15)
		if self.Options.RangeFrame then
			DBM.RangeCheck:Hide()
		end
		if self.Options.SoundWTF3 then
